...
- [x] If the solution is expected to have large volume of UDP traffic:
  ...
  - Consider using Highly Available NVAs for traffic inspection only and not for On Premises connectivity. 
